...
CREATE TABLE `user` (
  ...
  KEY `roleId` (`roleId`),
  KEY `user_ibfk_2_idx` (`groupId`),
  CONSTRAINT `user_ibfk_1` FOREIGN KEY (`roleId`) REFERENCES `role` (`roleId`) ON DELETE CASCADE,
  CONSTRAINT `user_ibfk_2` FOREIGN KEY (`groupId`) REFERENCES `edgroup` (`groupId`)
...
INSERT INTO `user` VALUES (1,'John','Doe','admin','a60b64e3e5e4a116f90ca38afa3965aab7fdf9f7bc0fc6d0d4b682af327def8e',1,'danmas.pp.ua@proton.me',1,0);
