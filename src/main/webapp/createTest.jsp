...
<main>
    ...
    <div id="modules" style="display: none">
        <hr>
        <form action="loadTestAccessPage">
            <input type="button" id="newModuleBtn" class="btn btn-primary" value="Додати модуль" onclick="showCreateModuleForm(this)">
            <input type="submit" class="btn btn-link" value="Закінчити створення тесту">
        </form>
    </div>
        ...
        <div class="login-form-block mb-2">
            <form>
                <p class="row mb-0">
                    ...
                    <input type="button" id="cMB" class="btn btn-primary float-end col m-2" value="Зберегти" onclick="createModule(this)">
                </p>
    ...
    <div id="createNewQuestion" style="display: none;">
        ...
        <div class="login-form-block mb-2">
            <form>
                <p class="row mb-0">
                    <button type="button" id="backQM" class="btn btn-light col m-2" onclick="backToModule(this)"><i class="bi bi-arrow-bar-left"></i> Назад</button>
                    <input type="button" id="qQ" class="btn btn-primary float-end col m-2" value="Зберегти" onclick="createQuestion(this)">
                </p>
                ...
                <p class="row">
                    <i class="col float-start">Варіант відповіді</i>
                    <i class="col float-end">Правильно</i>
                </p>
            </form>
        </div>
    </div>
